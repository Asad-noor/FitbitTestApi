...
import au.com.faqinteractive.fitbitauth.authentication.AuthenticationConfiguration;
import au.com.faqinteractive.fitbitauth.authentication.AuthenticationConfigurationBuilder;
import au.com.faqinteractive.fitbitauth.authentication.AuthenticationManager;
import au.com.faqinteractive.fitbitauth.authentication.ClientCredentials;
import au.com.faqinteractive.fitbitauth.authentication.Scope;

import static au.com.faqinteractive.fitbitauth.authentication.Scope.activity;
...
public class FitbitAuthApplication extends Application {
    ...
    public static AuthenticationConfiguration generateAuthenticationConfiguration(Context context, Class<? extends Activity> mainActivityClass) {
        ...
        try {
            ...
            String clientId = bundle.getString("au.com.faqinteractive.fitbittestapi.CLIENT_ID");
            String redirectUrl = bundle.getString("au.com.faqinteractive.fitbittestapi.REDIRECT_URL");
